...
app.getapp = (query) => {
	$.ajax({
		url:
			"https://kitsu.io/api/edge/anime?page[limit]=20&page[offset]=100&filter[categories]=" +
			query,
		...
		alldata.forEach((obj) => {
			...
			if (average > 70) {
				// this ensures that only animes whose average rating is above 70 get displayed
				...
				$(".flex-container").append(
					`<div class="container">
                        ...
                        <div class= "image">
                            ...
                            <img 
                                class="poster" 
                                src='${obj.attributes.posterImage.large}' 
                                alt="poster of ${obj.attributes.titles.en_jp}"
                            >
...
app.displayapp = function(da) {
	da.sort((a, b) =>
		a.attributes.ratingRank > b.attributes.ratingRank ? 1 : -1
	);
};
